...
import AccountsList from './modules/crm/pages/AccountsList';
import AccountForm from './modules/crm/pages/AccountForm';
import OpportunitiesList from './modules/crm/pages/OpportunitiesList';
import OpportunityForm from './modules/crm/pages/OpportunityForm';
import ContractsList from './modules/crm/pages/ContractsList';
import ContractForm from './modules/crm/pages/ContractForm';
import ContractDetail from './modules/crm/pages/ContractDetail';
                ...
                <AntApp>
                  ...
                  <Routes>
                    ...
                    <Route path="/hardware" element={
                      <ProtectedRoute>
                        <Layout><HardwareList /></Layout>
                      </ProtectedRoute>
                    } />
                    <Route path="/hardware/new" element={
                      <ProtectedRoute>
                        <Layout><HardwareForm /></Layout>
                      </ProtectedRoute>
                    } />
                    <Route path="/hardware/:id" element={
                      <ProtectedRoute>
                        <Layout><HardwareDetail /></Layout>
                      </ProtectedRoute>
                    } />
                    <Route path="/hardware/edit/:id" element={
                      <ProtectedRoute>
                        <Layout><HardwareForm /></Layout>
                      </ProtectedRoute>
                    } />
                    ...
                    <Route path="/credentials/new" element={
                      <ProtectedRoute>
                        <Layout><CredentialForm /></Layout>
                      </ProtectedRoute>
                    } />
                    <Route path="/credentials/:id" element={
                      <ProtectedRoute>
                        <Layout><CredentialDetail /></Layout>
                      </ProtectedRoute>
                    } />
                    <Route path="/credentials/edit/:id" element={
                      <ProtectedRoute>
                        <Layout><CredentialForm /></Layout>
                      </ProtectedRoute>
                    } />
                    ...
                    {/* دسته‌بندی‌ها */}
                    <Route path="/categories/:module" element={
                      <ProtectedRoute requiredRole="admin">
                    ...
                    {/* نامه‌ها */}
                    <Route path="/letters/dashboard" element={
                      <ProtectedRoute>
                        <Layout><LetterDashboard /></Layout>
                      </ProtectedRoute>
                    } />
                    <Route path="/letters/inbox" element={
                      <ProtectedRoute>
                        <Layout><LetterInbox /></Layout>
                      </ProtectedRoute>
                    } />
                    <Route path="/letters/outbox" element={
                      <ProtectedRoute>
                        <Layout><LetterOutbox /></Layout>
                      </ProtectedRoute>
                    } />
                    <Route path="/letters/pending" element={
                      <ProtectedRoute>
                        <Layout><LetterPending /></Layout>
                      </ProtectedRoute>
                    } />
                    <Route path="/letters/new" element={
                      <ProtectedRoute>
                        <Layout><LetterForm /></Layout>
                      </ProtectedRoute>
                    } />
                    ...
                    <Route path="/workflow/edit/:id" element={
                      <ProtectedRoute requiredRole="admin">
                        <Layout><WorkflowBuilder /></Layout>
                      </ProtectedRoute>
                    } />
                    ...
                    <Route path="/signatures" element={
                      <ProtectedRoute>
                        <Layout><SignatureList /></Layout>
                      </ProtectedRoute>
                    } />
                    <Route path="/signatures/pad/:id" element={
                      <ProtectedRoute>
                        <Layout><SignaturePad /></Layout>
                      </ProtectedRoute>
                    } />
                    ...
                    <Route path="/secretariats" element={
                      <ProtectedRoute>
                        <Layout><SecretariatList /></Layout>
                      </ProtectedRoute>
                    } />
                    <Route path="/secretariats/new" element={
                      <ProtectedRoute requiredRole="admin">
                        <Layout><SecretariatForm /></Layout>
                      </ProtectedRoute>
                    } />
                    <Route path="/secretariats/edit/:id" element={
                      <ProtectedRoute requiredRole="admin">
                        <Layout><SecretariatForm /></Layout>
                      </ProtectedRoute>
                    } />
                    <Route path="/secretariats/:id" element={
                      <ProtectedRoute>
                        <Layout><SecretariatDetail /></Layout>
                      </ProtectedRoute>
                    } />
                    <Route path="/correspondence" element={
                      <ProtectedRoute>
                        <Layout><CorrespondenceList /></Layout>
                      </ProtectedRoute>
                    } />
                    ...
                    <Route path="/archive" element={
                      <ProtectedRoute>
                        <Layout><ArchiveList /></Layout>
                      </ProtectedRoute>
                    } />
                    <Route path="/archive/new" element={
                      <ProtectedRoute requiredRole="admin">
                        <Layout><ArchiveForm /></Layout>
                      </ProtectedRoute>
                    } />
                    ...
                    <Route path="/archive/:id" element={
                      <ProtectedRoute>
                        <Layout><ArchiveDetail /></Layout>
                      </ProtectedRoute>
                    } />
                    <Route path="/archive/search" element={
                      <ProtectedRoute>
                    ...
                    {/* فکس */}
                    <Route path="/fax" element={
                      <ProtectedRoute>
                        <Layout><FaxList /></Layout>
                      </ProtectedRoute>
                    } />
                    <Route path="/fax/new" element={
                      <ProtectedRoute>
                        <Layout><FaxList /></Layout>
                      </ProtectedRoute>
                    } />
                    <Route path="/fax/:id" element={
                      <ProtectedRoute>
                        <Layout><FaxDetail /></Layout>
                      </ProtectedRoute>
                    } />
                    ...
                    <Route path="/webhooks/edit/:id" element={
                      <ProtectedRoute requiredRole="admin">
                        <Layout><WebhookForm /></Layout>
                      </ProtectedRoute>
                    } />
                    ...
                    {/* صفحات جدید */}
                    <Route path="/letter-numbering" element={
                      <ProtectedRoute requiredRole="admin">
                        <Layout><LetterNumberingList /></Layout>
                      </ProtectedRoute>
                    } />
                    <Route path="/ocr-search" element={
                      <ProtectedRoute>
                        <Layout><OCRSearch /></Layout>
                      </ProtectedRoute>
                    } />
                    <Route path="/delegation" element={
                      <ProtectedRoute>
                        <Layout><DelegationManager /></Layout>
                      </ProtectedRoute>
                    } />
                    <Route path="/referrals" element={
                      <ProtectedRoute>
                        <Layout><ReferralList /></Layout>
                      </ProtectedRoute>
                    } />
                    <Route path="/referrals/:id" element={
                      <ProtectedRoute>
                        <Layout><ReferralDetail /></Layout>
                      </ProtectedRoute>
                    } />
                    ...
                    <Route path="/cms/pages" element={
                      <ProtectedRoute requiredRole="admin">
                        <Layout><PagesList /></Layout>
                      </ProtectedRoute>
                    } />
                    <Route path="/cms/pages/new" element={
                      <ProtectedRoute requiredRole="admin">
                        <Layout><PageForm /></Layout>
                      </ProtectedRoute>
                    } />
                    <Route path="/cms/pages/edit/:id" element={
                      <ProtectedRoute requiredRole="admin">
                        <Layout><PageForm /></Layout>
                      </ProtectedRoute>
                    } />
                    <Route path="/cms/posts" element={
                      <ProtectedRoute requiredRole="admin">
                        <Layout><PostsList /></Layout>
                      </ProtectedRoute>
                    } />
                    <Route path="/cms/posts/new" element={
                      <ProtectedRoute requiredRole="admin">
                        <Layout><PostForm /></Layout>
                      </ProtectedRoute>
                    } />
                    <Route path="/cms/posts/edit/:id" element={
                      <ProtectedRoute requiredRole="admin">
                        <Layout><PostForm /></Layout>
                      </ProtectedRoute>
                    } />
                    ...
                    <Route path="/cms/tags" element={
                      <ProtectedRoute requiredRole="admin">
                        <Layout><TagsList /></Layout>
                      </ProtectedRoute>
                    } />
                    <Route path="/cms/comments" element={
                      <ProtectedRoute requiredRole="admin">
                        <Layout><CommentsList /></Layout>
                      </ProtectedRoute>
                    } />
                    ...
                    <Route path="/crm/leads/edit/:id" element={
                      <ProtectedRoute>
                        <Layout><LeadForm /></Layout>
                      </ProtectedRoute>
                    } />
                    ...
                    <Route path="/crm/accounts/edit/:id" element={
                      <ProtectedRoute>
                        <Layout><AccountForm /></Layout>
                      </ProtectedRoute>
                    } />
                    ...
                    <Route path="/crm/opportunities/new" element={
                      <ProtectedRoute>
                        <Layout><OpportunityForm /></Layout>
                      </ProtectedRoute>
                    } />
                    <Route path="/crm/opportunities/edit/:id" element={
                      <ProtectedRoute>
                        <Layout><OpportunityForm /></Layout>
                      </ProtectedRoute>
                    } />
                    ...
                    <Route path="/crm/contracts/new" element={
                      <ProtectedRoute>
                        <Layout><ContractForm /></Layout>
                      </ProtectedRoute>
                    } />
                    <Route path="/crm/contracts/edit/:id" element={
                      <ProtectedRoute>
                        <Layout><ContractForm /></Layout>
                      </ProtectedRoute>
                    } />
                    <Route path="/crm/contracts/:id" element={
                      <ProtectedRoute>
