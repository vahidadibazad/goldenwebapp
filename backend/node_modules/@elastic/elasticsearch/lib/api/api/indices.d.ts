...
export default class Indices {
    ...
    /**
      ...
      */
    deleteDataStreamOptions(this: That, params: T.IndicesDeleteDataStreamOptionsRequest | TB.IndicesDeleteDataStreamOptionsRequest, options?: TransportRequestOptionsWithOutMeta): Promise<T.IndicesDeleteDataStreamOptionsResponse>;
    deleteDataStreamOptions(this: That, params: T.IndicesDeleteDataStreamOptionsRequest | TB.IndicesDeleteDataStreamOptionsRequest, options?: TransportRequestOptionsWithMeta): Promise<TransportResult<T.IndicesDeleteDataStreamOptionsResponse, unknown>>;
    deleteDataStreamOptions(this: That, params: T.IndicesDeleteDataStreamOptionsRequest | TB.IndicesDeleteDataStreamOptionsRequest, options?: TransportRequestOptions): Promise<T.IndicesDeleteDataStreamOptionsResponse>;
    /**
    ...
    /**
      ...
      */
    getDataStreamOptions(this: That, params: T.IndicesGetDataStreamOptionsRequest | TB.IndicesGetDataStreamOptionsRequest, options?: TransportRequestOptionsWithOutMeta): Promise<T.IndicesGetDataStreamOptionsResponse>;
    getDataStreamOptions(this: That, params: T.IndicesGetDataStreamOptionsRequest | TB.IndicesGetDataStreamOptionsRequest, options?: TransportRequestOptionsWithMeta): Promise<TransportResult<T.IndicesGetDataStreamOptionsResponse, unknown>>;
    getDataStreamOptions(this: That, params: T.IndicesGetDataStreamOptionsRequest | TB.IndicesGetDataStreamOptionsRequest, options?: TransportRequestOptions): Promise<T.IndicesGetDataStreamOptionsResponse>;
    /**
      ...
      */
    getDataStreamSettings(this: That, params: T.IndicesGetDataStreamSettingsRequest | TB.IndicesGetDataStreamSettingsRequest, options?: TransportRequestOptionsWithOutMeta): Promise<T.IndicesGetDataStreamSettingsResponse>;
    getDataStreamSettings(this: That, params: T.IndicesGetDataStreamSettingsRequest | TB.IndicesGetDataStreamSettingsRequest, options?: TransportRequestOptionsWithMeta): Promise<TransportResult<T.IndicesGetDataStreamSettingsResponse, unknown>>;
    getDataStreamSettings(this: That, params: T.IndicesGetDataStreamSettingsRequest | TB.IndicesGetDataStreamSettingsRequest, options?: TransportRequestOptions): Promise<T.IndicesGetDataStreamSettingsResponse>;
    /**
    ...
    /**
      ...
      */
    putDataStreamOptions(this: That, params: T.IndicesPutDataStreamOptionsRequest | TB.IndicesPutDataStreamOptionsRequest, options?: TransportRequestOptionsWithOutMeta): Promise<T.IndicesPutDataStreamOptionsResponse>;
    putDataStreamOptions(this: That, params: T.IndicesPutDataStreamOptionsRequest | TB.IndicesPutDataStreamOptionsRequest, options?: TransportRequestOptionsWithMeta): Promise<TransportResult<T.IndicesPutDataStreamOptionsResponse, unknown>>;
    putDataStreamOptions(this: That, params: T.IndicesPutDataStreamOptionsRequest | TB.IndicesPutDataStreamOptionsRequest, options?: TransportRequestOptions): Promise<T.IndicesPutDataStreamOptionsResponse>;
    /**
      ...
      */
    putDataStreamSettings(this: That, params: T.IndicesPutDataStreamSettingsRequest | TB.IndicesPutDataStreamSettingsRequest, options?: TransportRequestOptionsWithOutMeta): Promise<T.IndicesPutDataStreamSettingsResponse>;
    putDataStreamSettings(this: That, params: T.IndicesPutDataStreamSettingsRequest | TB.IndicesPutDataStreamSettingsRequest, options?: TransportRequestOptionsWithMeta): Promise<TransportResult<T.IndicesPutDataStreamSettingsResponse, unknown>>;
    putDataStreamSettings(this: That, params: T.IndicesPutDataStreamSettingsRequest | TB.IndicesPutDataStreamSettingsRequest, options?: TransportRequestOptions): Promise<T.IndicesPutDataStreamSettingsResponse>;
    /**
