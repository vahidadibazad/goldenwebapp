...
export default class Connector {
    ...
    /**
      ...
      */
    secretDelete(this: That, params: T.ConnectorSecretDeleteRequest | TB.ConnectorSecretDeleteRequest, options?: TransportRequestOptionsWithOutMeta): Promise<T.ConnectorSecretDeleteResponse>;
    secretDelete(this: That, params: T.ConnectorSecretDeleteRequest | TB.ConnectorSecretDeleteRequest, options?: TransportRequestOptionsWithMeta): Promise<TransportResult<T.ConnectorSecretDeleteResponse, unknown>>;
    secretDelete(this: That, params: T.ConnectorSecretDeleteRequest | TB.ConnectorSecretDeleteRequest, options?: TransportRequestOptions): Promise<T.ConnectorSecretDeleteResponse>;
    /**
      * Retrieves a secret stored by Connectors.
      */
    secretGet(this: That, params: T.ConnectorSecretGetRequest | TB.ConnectorSecretGetRequest, options?: TransportRequestOptionsWithOutMeta): Promise<T.ConnectorSecretGetResponse>;
    secretGet(this: That, params: T.ConnectorSecretGetRequest | TB.ConnectorSecretGetRequest, options?: TransportRequestOptionsWithMeta): Promise<TransportResult<T.ConnectorSecretGetResponse, unknown>>;
    secretGet(this: That, params: T.ConnectorSecretGetRequest | TB.ConnectorSecretGetRequest, options?: TransportRequestOptions): Promise<T.ConnectorSecretGetResponse>;
    /**
      * Creates a secret for a Connector.
      */
    secretPost(this: That, params?: T.ConnectorSecretPostRequest | TB.ConnectorSecretPostRequest, options?: TransportRequestOptionsWithOutMeta): Promise<T.ConnectorSecretPostResponse>;
    secretPost(this: That, params?: T.ConnectorSecretPostRequest | TB.ConnectorSecretPostRequest, options?: TransportRequestOptionsWithMeta): Promise<TransportResult<T.ConnectorSecretPostResponse, unknown>>;
    secretPost(this: That, params?: T.ConnectorSecretPostRequest | TB.ConnectorSecretPostRequest, options?: TransportRequestOptions): Promise<T.ConnectorSecretPostResponse>;
    /**
      * Creates or updates a secret for a Connector.
      */
    secretPut(this: That, params: T.ConnectorSecretPutRequest | TB.ConnectorSecretPutRequest, options?: TransportRequestOptionsWithOutMeta): Promise<T.ConnectorSecretPutResponse>;
    secretPut(this: That, params: T.ConnectorSecretPutRequest | TB.ConnectorSecretPutRequest, options?: TransportRequestOptionsWithMeta): Promise<TransportResult<T.ConnectorSecretPutResponse, unknown>>;
    secretPut(this: That, params: T.ConnectorSecretPutRequest | TB.ConnectorSecretPutRequest, options?: TransportRequestOptions): Promise<T.ConnectorSecretPutResponse>;
    /**
